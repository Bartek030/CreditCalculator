...
public class ReferenceCalculationServiceImpl implements ReferenceCalculationService {
    ...
    @Override
    public MortgageReference calculate(final InputData inputData) {
        return new MortgageReference(inputData.getAmount(), inputData.getMonthsDuration());
    }

    @Override
    public MortgageReference calculate(final InputData inputData, final RateAmounts rateAmounts, final Rate previousRate) {
    ...
    private MortgageReference reduceRateMortgageReference(final RateAmounts rateAmounts, final Rate previousRate) {
